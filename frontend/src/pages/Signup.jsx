      ...
      <div className="max-w-xl mx-auto custom-shadow p-8 rounded-xl ">
        ...
        <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-1">
            ...
            <input type="text" id="fullName" name="fullName" className="border rounded-xl border-gray-300 text-lg px-4 py-2" required />
          </div>
          <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input type="text" id="phone" name="phone" className="border rounded-xl border-gray-300 text-lg px-4 py-2" required />
          </div>
